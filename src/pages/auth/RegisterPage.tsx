  ...
  return (
    <div className="min-h-screen bg-black flex overflow-hidden font-sans selection:bg-emerald/30 relative">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent p-24 flex flex-col justify-end relative z-10">
          ...
          >
            <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center apple-shadow-lg">
              <ShieldCheck className="w-8 h-8 text-harvest" />
            </div>
            ...
            <div className="flex items-center gap-12 pt-12">
              <div className="space-y-2">
                <div className="text-4xl font-bold text-white tracking-tighter tabular-nums">4.2.0</div>
                <div className="text-[10px] font-bold tracking-[0.2em] opacity-60 text-emerald uppercase">Protocol version</div>
              </div>
              <div className="w-px h-12 bg-white/10" />
              <div className="space-y-2">
                <div className="text-4xl font-bold text-white tracking-tighter tabular-nums">1.4M</div>
      ...
      <div className="w-full lg:w-1/2 overflow-y-auto px-8 py-20 lg:p-32 flex flex-col justify-center bg-black">
        <div className="max-w-[480px] mx-auto w-full space-y-16">
          <motion.div
          ...
          >
            <Link to="/" className="inline-flex items-center gap-4 group">
              ...
              <span className="text-2xl font-black text-white tracking-tighter font-sans">EXXCRYPT</span>
            </Link>
          </motion.div>

          <div className="space-y-4">
            <h2 className="text-4xl font-black text-white tracking-tight leading-tight">Identity ignition.</h2>
