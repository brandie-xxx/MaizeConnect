        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="space-y-6">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-[#1D1D1F] tracking-tight">Bridging the gap with simplicity.</h2>
            ...
            <div className="grid sm:grid-cols-2 gap-8">
              {[
                ...
                <div key={i} className="p-6 md:p-8 rounded-2xl lg:rounded-[2rem] bg-[#FAFAF9] border border-[#1D1D1F]/5 space-y-4">
        ...
        <div className="max-w-[1400px] mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12 lg:gap-16">
            <div className="lg:col-span-1 space-y-8">
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tight leading-[0.9]">The pillars of MaizeConnect.</h2>
            ...
            <div className="lg:col-span-2 grid sm:grid-cols-2 gap-8">
              {[
                ...
                <div key={i} className="p-6 md:p-8 lg:p-10 rounded-2xl lg:rounded-[3rem] bg-white/5 border border-white/10 hover:bg-white/10 transition-colors group">
                  ...
                  <h3 className="text-2xl md:text-3xl font-black mb-3 md:mb-4">{pillar.title}</h3>
                  <p className="text-sm md:text-base lg:text-lg text-white/60 font-medium leading-relaxed font-sans">{pillar.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 lg:gap-24 items-center relative z-10">
          <div className="order-2 lg:order-1 relative h-[400px] sm:h-[500px] md:h-[600px] bg-white rounded-2xl lg:rounded-[3rem] border border-[#1D1D1F]/5 shadow-2xl overflow-hidden flex items-center justify-center p-12">
             <div className="space-y-12 w-full max-w-sm">
                <div className="space-y-4 text-center">
                   ...
                   <h3 className="text-2xl sm:text-3xl md:text-4xl font-black text-[#1D1D1F]">The USSD advantage.</h3>
          ...
          <div className="order-1 lg:order-2 space-y-10">
            <div className="space-y-6">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-[#1D1D1F] tracking-tight leading-tight">Built for rural <br />resilience.</h2>
              <p className="text-base sm:text-lg md:text-xl text-[#1D1D1F]/85 font-medium leading-relaxed font-sans">
        ...
        <div className="max-w-[1400px] mx-auto">
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 lg:gap-24 items-center">
              <div className="space-y-10">
                 <div className="space-y-6">
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-[#1D1D1F] tracking-tight">An ecosystem for millers and farmers.</h2>
                 ...
                 <div className="space-y-6">
                    {[
                      ...
                      <div key={item.h} className="p-5 sm:p-6 md:p-8 rounded-2xl lg:rounded-[2rem] bg-[#FDFEFC] border border-[#1D1D1F]/10 space-y-2">
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-16 sm:py-20 md:py-24 lg:py-32">
        <div className="max-w-[1400px] mx-auto space-y-12 md:space-y-16 lg:space-y-24">
          <div className="text-center space-y-6">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tight">Our scale in 2026.</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8">
            {[
              ...
              <div key={i} className="p-6 md:p-8 lg:p-12 bg-white rounded-2xl lg:rounded-[3rem] border border-[#1D1D1F]/10 shadow-xl shadow-black/5 text-center space-y-2">
                <div className="text-3xl sm:text-4xl md:text-5xl font-black text-[#1D1D1F] tracking-tighter">{stat.value}</div>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-16 sm:py-20 md:py-24 lg:py-32 bg-maize/10 mx-2 sm:mx-4 rounded-3xl lg:rounded-[4rem] mb-16 sm:mb-20 md:mb-24 lg:mb-32 relative overflow-hidden">
        <div className="max-w-[1000px] mx-auto text-center space-y-12 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
            ...
            <Link to="/">
               <Button size="lg" className="h-14 md:h-16 lg:h-[74px] bg-harvest text-white rounded-2xl lg:rounded-[2.5rem] px-8 md:px-10 lg:px-12 font-bold text-base hover:-translate-y-1.5 transition-transform active:scale-95 shadow-2xl shadow-harvest/30">
                 Explore marketplace
               </Button>
            </Link>
          </div>
